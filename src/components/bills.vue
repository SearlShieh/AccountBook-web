<template>
  <div id="mainapp">
      ...
      <el-carousel indicator-position="none" arrow="hover" :autoplay="false" width="500px" height="520px"
        ...
        <el-carousel-item v-for="item in books" :key="item.id">
          ...
          <div style="margin-bottom:1%;text-align:left;margin-left: 1%;">
            ...
            <el-tag effect="dark" size="small" style="position:relative;top:-9px;" >标签</el-tag>
            <el-button-group style="float: right;position: relative;right: 1%;top:5px" v-if="item.isMonthly==0">
          ...
          <el-tooltip effect="light" content="添加邀请人" placement="bottom-start" v-if="item.isPrivate==0">
          ...
          <el-tooltip effect="light" content="邀请记录" placement="bottom-start" v-if="item.isPrivate==0">
            <el-button type="success" size="small" circle style="padding:4px;float:right;position: relative;top:3px"
          ...
          <!-- 账单列表 -->
                  <div class="bookapp2">
                    ...
                    <el-button  size="mini" style="padding:4px 4px 4px 4px;position:relative;top:-7px;float: right;" 
                        @click="changeToSomeBill(item.recordId)">编辑</el-button>
    ...
    <el-card class="box-card3" v-else>
      <span style="text-align:center;font-size:24px;" >账单信息</span>
...
<hr style="border-style:dashed;color:#C0C0C0;position:relative;top:15px;"  SIZE=1/>
      ...
      <el-tooltip effect="light" content="保存修改" placement="bottom-start">
