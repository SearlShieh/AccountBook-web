  ...
  <div id="mainapp">
    <div class="left">
      <el-card style="background:rgba(255, 255, 255, 0.1);margin-bottom: 2%;">
        <!-- <div style="background-image: url('../img/1.jpg');width: 100px ;height: 100px;"></div> -->
        <img :src="require('../img/'+user.iconIndex+'.jpg')" style="width: 14%;height: 14%;border-radius: 100%;float: left;
          margin-top: -14px;margin-left: -10px;" @click="iconVisible=true">
        ...
        <div style="font-size:12px;color:#918c8c;margin-left: 4px;">
          个性签名：{{user.sign}}
        </div>  
      </el-card>
      ...
      <el-card style="background:rgba(255, 255, 255, 0.1);margin-top: 2%;">
        ...
        <div  style="width: 350px;height: 50px;position: relative;float: left;">
          <el-tag size="medium" style="float: left;">每日的记账时间</el-tag>
          <i  class="el-icon-edit-outline" style="float: right;margin-left: 1%;"  @click="timeVisible=true"/>
          <span style="float: right;color:#888585;margin-top: 1%;">{{user.time.hour}}&nbsp：{{user.time.min}}</span>
        </div>
      </el-card>
    ...
    <el-dialog
      ...
      <div style="max-height: 48vh;overflow: auto;">
        <span v-for="item in 12" style="display: inline-block;width: 20%;margin-right: 5%;margin-bottom: 5%;">
          <img  :src="require('../img/'+item+'.jpg')" style="width: 100%;height:auto;border: 2px solid rgb(0, 0, 0);"/>
          <el-radio v-model="iconRadio" :label="item" >头像{{item}}</el-radio>
        </span>
      </div>
      <div style="width: 100%;display: flex;justify-content: center;">
        <el-button type="success" style="padding: 6px 12px;margin-top: 5%;" @click="updateIcon">确认设置</el-button>
      </div>
    </el-dialog>
    <el-dialog
      title="设置记账时间"
      ...
      <div style="display: flex;justify-content: center;align-items: center;">
        <el-input-number v-model="user.newTime.hour" @change="handleChange" :min="0" :max="23" 
          style="margin-right: 5%;margin-bottom: 2%;"></el-input-number>时
      </div>
      <div style="display: flex;justify-content: center;align-items: center;">
        <el-input-number v-model="user.newTime.min" @change="handleChange" :min="0" :max="60" 
          style="margin-right: 5%;margin-bottom: 2%;"></el-input-number>分
      </div>
      <div style="display: flex;justify-content: center;">
        <el-button type="success" style="padding: 6px 12px;margin-top: 5%;" @click="updateTime">确认设置</el-button>
      </div>
    ...
    handleChange(value) {
      ...
      updateIcon(){
        ...
        this.axios({
          ...
          this.user.iconIndex=this.iconRadio;
